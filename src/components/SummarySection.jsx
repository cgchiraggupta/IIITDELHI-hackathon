      ...
      <div className="medical-card">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-yellow-800">No Analysis Available</h3>
              <p className="text-yellow-700">Please capture and analyze a medical report first.</p>
            </div>
          </div>
        </div>
      </div>
